...
const inputCls = "w-full border border-[#d4e8d4] bg-white py-3 px-4 text-sm text-[#1a3a1a] placeholder:text-[#6B7280] outline-none focus:border-[#C2185B] focus:ring-2 focus:ring-[#C2185B]/10 transition-all rounded-xl";
...
const INFLUENCIADORES_CATEGORIES = [
  { number: "01", title: "Redes Sociais & Marketing Digital", intro: "Gestão e estratégia de redes sociais.", items: ["Instagram", "TikTok", "YouTube", "Facebook"], category: "redes-sociais" },
  { number: "02", title: "Criação de Conteúdo", intro: "Produção de conteúdo criativo e envolvente.", items: ["Fotografia", "Vídeo", "Copywriting", "Storytelling"], category: "criacao-conteudo" },
  { number: "03", title: "Gestão de Marca Pessoal", intro: "Construção e gestão de marca pessoal.", items: ["Personal Branding", "Posicionamento", "Estratégia de Marca", "Identidade Visual"], category: "marca-pessoal" },
  { number: "04", title: "Podcast & Áudio", intro: "Produção de conteúdo áudio.", items: ["Podcasts", "Locução", "Edição de Áudio", "Rádio Online"], category: "podcast" },
  { number: "05", title: "Design & Criatividade", intro: "Serviços de design e criatividade.", items: ["Graphic Design", "UI/UX", "Motion Graphics", "Ilustração"], category: "design" },
  { number: "06", title: "E-commerce & Afiliados", intro: "Vendas online e programas de afiliados.", items: ["Loja Online", "Marketing de Afiliados", "Dropshipping", "Infoprodutos"], category: "ecommerce" },
  { number: "07", title: "Eventos & Encontros", intro: "Organização de eventos e encontros.", items: ["Meet & Greet", "Workshops", "Conferências", "Lançamentos"], category: "eventos-inf" },
  { number: "08", title: "Consultoria Digital", intro: "Assessoria em marketing digital.", items: ["Consultoria de Redes Sociais", "Estratégia Digital", "Análise de Dados", "Mentoria"], category: "consultoria-digital" },
  { number: "09", title: "Fotografia & Videografia", intro: "Serviços profissionais de imagem.", items: ["Sessões Fotográficas", "Videoclipes", "Cobertura de Eventos", "Edição de Vídeo"], category: "fotografia" },
  { number: "10", title: "Publicidade & Parcerias", intro: "Gestão de publicidade e parcerias.", items: ["Publicidade Paga", "Parcerias de Marca", "Sponsorships", "Colaborações"], category: "publicidade" },
  { number: "11", title: "Educação Online", intro: "Cursos e formação online.", items: ["Cursos Online", "Mentorias", "Webinars", "E-books"], category: "educacao-online" },
  { number: "12", title: "Produção Audiovisual", intro: "Produção de conteúdos audiovisuais.", items: ["Produção de Vídeo", "Edição Profissional", "Animação", "Efeitos Especiais"], category: "audiovisual" },
];

export default function DashboardInfluencers() {
  ...
  useEffect(() => {
    if (!localUser) setLoc("/login-influenciadores");
  }, [localUser, setLoc]);
  ...
  if (!isAdmin && localUser.status === "PENDENTE") {
    return (
      <PageTransition>
        <div className="min-h-screen bg-[#fdf2f6] flex items-center justify-center px-4" style={{ fontFamily: "'DM Sans', sans-serif" }}>
          <div className="max-w-md w-full text-center space-y-6">
            ...
            <div className="flex flex-col gap-2 pt-2">
              <button onClick={handleRefreshStatus} className="w-full bg-[#C2185B] text-white py-2.5 rounded-full text-xs font-semibold hover:bg-[#880E4F] transition-colors flex items-center justify-center gap-1.5"><RefreshCw size={13} /> Atualizar Status</button>
              <button onClick={() => setLoc("/login-influenciadores")} className="w-full border border-[#d4e8d4] text-[#6B7280] hover:bg-[#f0f0f0] py-2.5 rounded-full text-xs font-semibold transition-colors flex items-center justify-center gap-1.5">Voltar ao Login</button>
            </div>
          </div>
        </div>
      </PageTransition>
  ...
  if (isLoading) return <div className="min-h-screen flex items-center justify-center bg-[#fdf2f6]"><p className="text-sm text-[#6B7280]">Carregando...</p></div>;

  return (
    <PageTransition>
      <div className="min-h-screen bg-[#fdf2f6] flex" style={{ fontFamily: "'DM Sans', sans-serif" }}>

        {/* Mobile Header */}
        <div className="md:hidden fixed top-0 left-0 right-0 z-40 bg-[#C2185B] text-white px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span style={{ fontFamily: "'Playfair Display', serif", fontSize: "15px", letterSpacing: "-.02em", color: "#fff" }}>YESOLA<small style={{ display: "block", color: "#F48FB1", fontFamily: "'DM Sans', sans-serif", textTransform: "uppercase", letterSpacing: ".23em", fontSize: "7px", marginTop: "1px" }}>Influencers</small></span>
          </div>
        ...
        {/* Sidebar */}
        <aside className={`${mobileMenuOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 fixed md:sticky top-0 left-0 z-30 w-64 bg-[#C2185B] text-white h-screen p-4 flex flex-col overflow-y-auto transition-transform duration-300`}>
          <div className="flex items-center gap-3 mb-5">
            <div>
              <span style={{ fontFamily: "'Playfair Display', serif", fontSize: "15px", letterSpacing: "-.02em" }}>YESOLA</span>
              <p style={{ fontFamily: "'DM Sans', sans-serif", textTransform: "uppercase", letterSpacing: ".23em", fontSize: "7px", color: "#F48FB1", marginTop: "1px" }}>Influencers</p>
        ...
        <main className="flex-1 p-4 pt-16 md:p-8 md:pt-8 overflow-y-auto">
          ...
          {section === "admin" && <AdminPanel storeType="influenciadores-criadores" accentColor="#C2185B" />}
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
            <motion.div initial={{ scale: 0.95 }} animate={{ scale: 1 }} exit={{ scale: 0.95 }} className="bg-white rounded-2xl p-8 max-w-sm w-full">
              ...
              <div className="flex gap-3 mt-6">
                <button onClick={handleForceChangePwd} disabled={pwdLoading} className="flex-1 bg-[#C2185B] text-white py-3 rounded-xl text-sm font-medium hover:bg-[#880E4F] transition-colors">{pwdLoading ? "A guardar..." : "Guardar"}</button>
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        {isDirty && <button onClick={handleSave} disabled={mutation.isPending} className="bg-[#C2185B] text-white px-6 py-2.5 rounded-full text-sm font-medium hover:bg-[#880E4F] transition-colors">{mutation.isPending ? "A guardar..." : "Guardar alterações"}</button>}
      ...
      <div className="bg-white rounded-2xl border border-[#d4e8d4] p-8 space-y-6 max-w-2xl mb-6">
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <label className="flex items-center gap-2 px-4 py-2.5 border border-dashed border-[#d4e8d4] rounded-xl text-xs text-[#6B7280] hover:border-[#C2185B] hover:text-[#1a3a1a] cursor-pointer transition-colors">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3 mb-3">
            ...
            <label className="w-24 h-24 border border-dashed border-[#d4e8d4] rounded-xl flex flex-col items-center justify-center text-[10px] text-[#6B7280] hover:border-[#C2185B] hover:text-[#1a3a1a] cursor-pointer transition-colors">
      ...
      <div className="bg-white rounded-2xl border border-[#d4e8d4] p-8 space-y-6 max-w-2xl">
        ...
        <div>
          ...
          <CategoryMultiSelect options={getAreaCategories("influenciadores-criadores")} value={form.categories ?? []} onChange={(next) => { setForm((prev) => ({ ...prev, categories: next })); setDirty(true); }} max={4} accent="#C2185B" />
        </div>
        <div className="grid grid-cols-2 gap-4">
          <LocationCombobox label="Província" value={form.province} options={ANGOLA_PROVINCES.map((p) => p.name)} onChange={(v) => { handleChange("province", v); handleChange("municipality", ""); handleChange("locality", ""); }} placeholder="Selecione a Província" accent="#C2185B" />
          <LocationCombobox label="Município" value={form.municipality} options={ANGOLA_PROVINCES.find((p) => p.name === form.province)?.municipalities || []} onChange={(v) => { handleChange("municipality", v); handleChange("locality", ""); }} placeholder={form.province ? "Selecione o Município" : "Selecione a província primeiro"} disabled={!form.province} accent="#C2185B" />
        </div>
        <LocationCombobox label="Localidade exacta" value={form.locality} options={getLocalities(form.province, form.municipality)} onChange={(v) => handleChange("locality", v)} placeholder={form.municipality ? "Selecione a localidade" : "Selecione o município primeiro"} disabled={!form.municipality} accent="#C2185B" />
        <div>
...
function ProdutosSection({ store }: { store: any }) {
  ...
  const createMut = useMutation({
    mutationFn: async () => {
      ...
      const selectedCat = INFLUENCIADORES_CATEGORIES.find((g) => g.title === form.category);
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <button onClick={() => { setShowForm(!showForm); setEditProduct(null); setForm({ name: "", price: "", currency: "AOA", category: "", subcategory: "", description: "" }); setProductImages([]); }} className="flex items-center gap-2 bg-[#C2185B] text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-[#880E4F] transition-colors"><Plus size={15} /> Novo serviço</button>
      </div>
        ...
        {showForm && (
          <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="overflow-hidden mb-8">
            <div className="bg-white rounded-2xl border border-[#d4e8d4] p-6 space-y-4 max-w-2xl">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 mb-3">
                  ...
                  {productImages.length < 5 && (
                    <label className="w-20 h-20 border border-dashed border-[#d4e8d4] rounded-xl flex flex-col items-center justify-center text-[10px] text-[#6B7280] hover:border-[#C2185B] hover:text-[#1a3a1a] cursor-pointer transition-colors">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <select value={form.category} onChange={(e) => setForm({ ...form, category: e.target.value })} className={inputCls}>
                    ...
                    {INFLUENCIADORES_CATEGORIES.map((group) => <option key={group.category} value={group.title}>{group.number} — {group.title.split(",")[0]}</option>)}
                  </select>
                </div>
              </div>
              <div>
                ...
                <select value={form.subcategory} onChange={(e) => setForm({ ...form, subcategory: e.target.value })} className={inputCls} disabled={!form.category}>
                  <option value="">Selecionar...</option>
                  {INFLUENCIADORES_CATEGORIES.find((g) => g.title === form.category)?.items.map((item) => <option key={item} value={item}>{item}</option>)}
                </select>
              </div>
              ...
              <button onClick={() => createMut.mutate()} disabled={createMut.isPending || !form.name} className="bg-[#C2185B] text-white px-6 py-2.5 rounded-full text-sm font-medium hover:bg-[#880E4F] transition-colors disabled:opacity-50">
      ...
      <div className="space-y-6">
        {INFLUENCIADORES_CATEGORIES.filter((group) => getProductsForGroup(group.category).length > 0).map((group) => {
