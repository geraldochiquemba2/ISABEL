  ...
  return (
    <div className="min-h-[100dvh] bg-[#fce4ec] text-[#3a1a2a] pb-6" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <section className="px-5 py-3">
        <div className="flex items-center gap-4 bg-white rounded-2xl px-4 py-4 border border-[#f8bbd0]">
          ...
          <div className="flex-1">
            <p className="text-[14px] font-semibold text-[#C2185B]">Em todas as províncias de Angola</p>
            <p className="text-[11px] text-[#6B7280]">Criadores de conteúdo perto de si, onde estiver.</p>
          </div>
