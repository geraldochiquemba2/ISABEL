  ...
  return (
    <div className="min-h-[100dvh] bg-[#e3f2fd] text-[#1a3a5a] pb-6" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <section className="px-5 py-3">
        <div className="flex items-center gap-4 bg-white rounded-2xl px-4 py-4 border border-[#bbdefb]">
          ...
          <div className="flex-1">
            <p className="text-[14px] font-semibold text-[#1565C0]">Em todas as províncias de Angola</p>
            <p className="text-[11px] text-[#6B7280]">Tecnologia e electrónica perto de si, onde estiver.</p>
          </div>
