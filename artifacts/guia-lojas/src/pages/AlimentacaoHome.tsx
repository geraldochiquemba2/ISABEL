  ...
  return (
    <div className="min-h-[100dvh] bg-[#fbe9e7] text-[#3a1a1a] pb-6" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <section className="px-5 py-3">
        <div className="flex items-center gap-4 bg-white rounded-2xl px-4 py-4 border border-[#ffccbc]">
          ...
          <div className="flex-1">
            <p className="text-[14px] font-semibold text-[#D84315]">Em todas as províncias de Angola</p>
            <p className="text-[11px] text-[#6B7280]">Opções gastronómicas perto de si, onde estiver.</p>
          </div>
