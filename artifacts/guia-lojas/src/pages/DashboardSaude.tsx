...
const SAUDE_CATEGORIES = [
  ...
  { number: "05", title: "Farmácias", intro: "Medicamentos e produtos de saúde ao seu alcance.", items: ["Farmácias", "Parafarmácias", "Produtos de Primeiros Socorros", "Produtos de Saúde"], category: "farmacias" },
  { number: "06", title: "Ópticas & Saúde Visual", intro: "Cuidar da visão é cuidar da qualidade de vida.", items: ["Ópticas", "Óculos Graduados", "Lentes", "Optometria", "Acessórios Ópticos"], category: "opticas" },
  { number: "07", title: "Pediatria & Neonatologia", intro: "Cuidados especializados para os mais pequenos.", items: ["Pediatria Geral", "Neonatologia", "Desenvolvimento Infantil"], category: "pediatria" },
  { number: "08", title: "Terapias Alternativas & Bem-Estar", intro: "Equilíbrio e harmonia para o corpo e mente.", items: ["Acupunctura & Medicina Tradicional", "Aromaterapia & Fitoterapia", "Yoga & Meditação"], category: "terapias" },
  { number: "09", title: "Nutrição & Dietética", intro: "Alimentação saudável para uma vida melhor.", items: ["Nutrição Clínica", "Dietas Especiais", "Aconselhamento Nutricional"], category: "nutricao" },
  { number: "10", title: "Fisioterapia & Reabilitação", intro: "Recuperação e prevenção de lesões.", items: ["Fisioterapia Ortopédica", "Reabilitação Cardiopulmonar", "Pilates Terapêutico"], category: "fisioterapia" },
  { number: "11", title: "Análises Clínicas & Exames", intro: "Diagnóstico preciso e rápido.", items: ["Análises Clínicas Gerais", "Exames de Imagem", "Check-ups Completos"], category: "analises" },
  { number: "12", title: "Planos de Saúde & Seguros", intro: "Proteção e tranquilidade para si e a sua família.", items: ["Seguros de Saúde", "Planos Familiares", "Cobertura Internacional"], category: "planos" },
];
    ...
    <PageTransition>
      <div className="min-h-screen bg-[#f0f7f0] flex" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <main className="flex-1 p-4 pt-16 md:p-8 md:pt-8 overflow-y-auto">
          ...
          {section === "admin" && <AdminPanel storeType="saude" accentColor="#2E7D32" />}
