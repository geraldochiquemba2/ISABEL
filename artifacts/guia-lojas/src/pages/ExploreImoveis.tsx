  ...
  return (
    <main className="min-h-[100dvh] bg-[#f8f6f3] text-[#0B2D56]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="mx-auto max-w-[1380px] px-6 pt-28 pb-12 md:px-12">
        ...
        <div className="mb-6">
          <span className="text-xs uppercase tracking-[0.15em] text-[#A7B3C5] mr-2">Onde procuras?</span>
          <div className="mt-2 max-w-md">
            <WhereSearch onScope={setLocationScope} onClear={() => setLocationScope(null)} accent="#0B2D56" />
          </div>
          {locationScope && (
            <button
