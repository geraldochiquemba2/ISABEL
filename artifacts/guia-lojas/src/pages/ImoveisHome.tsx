...
function Monogram() {
  return (
    <div className="flex items-center gap-3">
      ...
      />
      <span className="font-['Playfair_Display'] text-xl tracking-[0.08em] text-[#1a5276]">YESOLA <i className="font-normal">Imóveis & Alojamento</i></span>
    </div>
  );
}
  ...
  return (
    <main className="min-h-[100dvh] overflow-x-hidden bg-[#f8f6f3] text-[#1a5276]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 mx-auto flex max-w-[1380px] items-center justify-between px-6 py-6 md:px-12 bg-[#f8f6f3]/90 backdrop-blur-md">
        <a className="flex items-center gap-3 no-underline" href="#top" aria-label="YESOLA Imóveis & Alojamento">
          <img
          ...
          />
          <span style={{ fontFamily: "'Playfair Display', serif", fontSize: "19px", letterSpacing: "-.02em", color: "#1a5276" }}>YESOLA<small style={{ display: "block", color: "#c9913a", fontFamily: "'DM Sans', sans-serif", textTransform: "uppercase", letterSpacing: ".23em", fontSize: "8px", marginTop: "2px" }}>Imóveis & Alojamento</small></span>
        </a>
      ...
      <div className="eliora-grain">
          ...
          <div className="mx-auto grid max-w-[1380px] gap-10 px-6 py-10 md:grid-cols-[.75fr_1.25fr] md:px-12 md:py-14">
            ...
            <div className="grid gap-10 md:grid-cols-[minmax(0,1fr)_220px] md:items-end">
              <div>
                ...
                <p className="mt-8 max-w-xl text-sm leading-7 text-[#f8f6f3]/60">Na YESOLA, combinamos conhecimento do mercado com atenção personalizada. Cada imóvel, cada estadia, cada oportunidade é tratada com rigor e cuidado para garantir a melhor experiência.</p>
              </div>
        ...
        <section id="contacto" className="relative overflow-hidden border-t border-[#c9913a]/20 bg-[#1a5276] px-6 py-14 text-[#f8f6f3] md:px-12 md:py-20">
          ...
          <div className="relative mx-auto max-w-[1380px] md:flex md:items-end md:justify-between"><div><p className="font-mono text-[10px] uppercase tracking-[.25em] text-[#c9913a]">O primeiro passo</p><h2 className="mt-5 max-w-2xl font-['Playfair_Display'] text-5xl leading-[1.02] md:text-7xl">Vamos encontrar<br /><i>o seu espaço?</i></h2></div><div className="mt-10 md:mt-0 md:w-80"><p className="text-sm leading-6 text-[#f8f6f3]/60">Conte-nos o que procura. A nossa equipa responde com tempo, atenção e as melhores opções.</p><button onClick={() => { window.open("https://wa.me/244922001778?text=Ol%C3%A1%2C%20vim%20pela%20YESOLA%20Im%C3%B3veis%20%26%20Alojamento%20e%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es.", "_blank"); setSent(true); }} className="mt-7 flex items-center gap-4 border-b border-[#c9913a] pb-3 text-xs uppercase tracking-[.2em] text-[#f8f6f3]">{sent ? "Mensagem recebida" : "Falar com a equipa"} <ArrowRight size={15} /></button></div></div>
        </section>

        <footer className="mx-auto flex max-w-[1380px] flex-col gap-8 px-6 py-10 md:flex-row md:items-center md:justify-between md:px-12"><Monogram /><p className="text-xs text-[#1a5276]/60">Conforto e confiança, em Angola e além.</p><div className="flex items-center gap-5 text-[#1a5276]/60"><a href="https://wa.me/244922001778?text=Ol%C3%A1%2C%20vim%20pela%20YESOLA%20Im%C3%B3veis%20%26%20Alojamento%20e%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es." target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">WhatsApp</a><span className="font-mono text-[10px] tracking-[.2em]">© YESOLA</span></div></footer>
      </div>
    </main>
  );
}
