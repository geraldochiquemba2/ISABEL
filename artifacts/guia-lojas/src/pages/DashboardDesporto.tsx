...
const inputCls = "w-full border border-[#d4e8d4] bg-white py-3 px-4 text-sm text-[#1a3a1a] placeholder:text-[#6B7280] outline-none focus:border-[#E65100] focus:ring-2 focus:ring-[#E65100]/10 transition-all rounded-xl";
...
const DESPORTO_CATEGORIES = [
  { number: "01", title: "Academias & Ginásios", intro: "Espaços equipados para treino físico.", items: ["Academias", "Ginásios", "Estúdios de Fitness", "Academias 24h"], category: "academias" },
  { number: "02", title: "Personal Training", intro: "Treinamento personalizado e especializado.", items: ["Personal Trainers", "Treino Online", "Planos de Treino", "Consultoria Fitness"], category: "personal-training" },
  { number: "03", title: "Artes Marciais & Combate", intro: "Disciplinas de combate e autodefesa.", items: ["Boxe", "MMA", "Jiu-Jitsu", "Muay Thai", "Karatê"], category: "artes-marciais" },
  { number: "04", title: "Yoga & Pilates", intro: "Equilíbrio entre corpo e mente.", items: ["Yoga", "Pilates", "Meditação", "Aulas de Flexibilidade"], category: "yoga-pilates" },
  { number: "05", title: "Desportos Aquáticos", intro: "Atividades aquáticas e natação.", items: ["Natação", "Mergulho", "Surf", "Kayak"], category: "aquaticos" },
  { number: "06", title: "Desportos de Equipa", intro: "Modalidades colectivas e competições.", items: ["Futebol", "Basquetebol", "Voleibol", "Andebol"], category: "equipa" },
  { number: "07", title: "Ciclismo & Corrida", intro: "Desportos de resistência e velocidade.", items: ["Ciclismo", "Corrida", "Trail Running", "Marcha Atlética"], category: "ciclismo" },
  { number: "08", title: "Aventura & Outdoor", intro: "Atividades ao ar livre e de aventura.", items: ["Escalada", "Caminhadas", "Parapente", "Tiro com Arco"], category: "aventura" },
  { number: "09", title: "Equipamentos & Vestuário", intro: "Artigos desportivos e acessórios.", items: ["Vestuário Desportivo", "Calçado Desportivo", "Acessórios de Treino", "Equipamento de Ginning"], category: "equipamentos" },
  { number: "10", title: "Nutrição & Suplementação", intro: "Suplementos e aconselhamento nutricional.", items: ["Suplementos Desportivos", "Proteínas", "Vitaminas", "Aconselhamento Nutricional"], category: "nutricao" },
  { number: "11", title: "Eventos & Competições", intro: "Eventos desportivos e competições.", items: ["Maratonas", "Torneios", "Competições Locais", "Eventos Corporativos"], category: "eventos" },
  { number: "12", title: "Saúde & Recuperação", intro: "Serviços de recuperação e prevenção.", items: ["Fisioterapia Desportiva", "Massagens", "Recuperação Muscular", "Medicina Desportiva"], category: "saude" },
];

export default function DashboardDesporto() {
  ...
  useEffect(() => {
    if (!localUser) setLoc("/login-desporto");
  }, [localUser, setLoc]);
  ...
  if (!isAdmin && localUser.status === "PENDENTE") {
    return (
      <PageTransition>
        <div className="min-h-screen bg-[#fef6f0] flex items-center justify-center px-4" style={{ fontFamily: "'DM Sans', sans-serif" }}>
          <div className="max-w-md w-full text-center space-y-6">
            ...
            <div className="flex flex-col gap-2 pt-2">
              ...
              <button onClick={() => setLoc("/login-desporto")} className="w-full border border-[#d4e8d4] text-[#6B7280] hover:bg-[#f0f0f0] py-2.5 rounded-full text-xs font-semibold transition-colors flex items-center justify-center gap-1.5">Voltar ao Login</button>
            </div>
          </div>
        </div>
      </PageTransition>
  ...
  if (isLoading) return <div className="min-h-screen flex items-center justify-center bg-[#fef6f0]"><p className="text-sm text-[#6B7280]">Carregando...</p></div>;

  return (
    <PageTransition>
      <div className="min-h-screen bg-[#fef6f0] flex" style={{ fontFamily: "'DM Sans', sans-serif" }}>

        {/* Mobile Header */}
        <div className="md:hidden fixed top-0 left-0 right-0 z-40 bg-[#E65100] text-white px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span style={{ fontFamily: "'Playfair Display', serif", fontSize: "15px", letterSpacing: "-.02em", color: "#fff" }}>YESOLA<small style={{ display: "block", color: "#FFCC80", fontFamily: "'DM Sans', sans-serif", textTransform: "uppercase", letterSpacing: ".23em", fontSize: "7px", marginTop: "1px" }}>Desporto</small></span>
          </div>
        ...
        {/* Sidebar */}
        <aside className={`${mobileMenuOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 fixed md:sticky top-0 left-0 z-30 w-64 bg-[#E65100] text-white h-screen p-4 flex flex-col overflow-y-auto transition-transform duration-300`}>
          <div className="flex items-center gap-3 mb-5">
            <div>
              <span style={{ fontFamily: "'Playfair Display', serif", fontSize: "15px", letterSpacing: "-.02em" }}>YESOLA</span>
              <p style={{ fontFamily: "'DM Sans', sans-serif", textTransform: "uppercase", letterSpacing: ".23em", fontSize: "7px", color: "#FFCC80", marginTop: "1px" }}>Desporto</p>
        ...
        <main className="flex-1 p-4 pt-16 md:p-8 md:pt-8 overflow-y-auto">
          ...
          {section === "admin" && <AdminPanel storeType="desporto-fitness" accentColor="#E65100" />}
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
            <motion.div initial={{ scale: 0.95 }} animate={{ scale: 1 }} exit={{ scale: 0.95 }} className="bg-white rounded-2xl p-8 max-w-sm w-full">
              ...
              <div className="flex gap-3 mt-6">
                <button onClick={handleForceChangePwd} disabled={pwdLoading} className="flex-1 bg-[#E65100] text-white py-3 rounded-xl text-sm font-medium hover:bg-[#BF360C] transition-colors">{pwdLoading ? "A guardar..." : "Guardar"}</button>
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        {isDirty && <button onClick={handleSave} disabled={mutation.isPending} className="bg-[#E65100] text-white px-6 py-2.5 rounded-full text-sm font-medium hover:bg-[#BF360C] transition-colors">{mutation.isPending ? "A guardar..." : "Guardar alterações"}</button>}
      ...
      <div className="bg-white rounded-2xl border border-[#d4e8d4] p-8 space-y-6 max-w-2xl mb-6">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3 mb-3">
            ...
            <label className="w-24 h-24 border border-dashed border-[#d4e8d4] rounded-xl flex flex-col items-center justify-center text-[10px] text-[#6B7280] hover:border-[#E65100] hover:text-[#1a3a1a] cursor-pointer transition-colors">
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <button onClick={() => { setShowForm(!showForm); setEditProduct(null); setForm({ name: "", price: "", currency: "AOA", category: "", subcategory: "", description: "" }); setProductImages([]); }} className="flex items-center gap-2 bg-[#E65100] text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-[#BF360C] transition-colors"><Plus size={15} /> Novo serviço</button>
      </div>
        ...
        {showForm && (
          <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="overflow-hidden mb-8">
            <div className="bg-white rounded-2xl border border-[#d4e8d4] p-6 space-y-4 max-w-2xl">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 mb-3">
                  ...
                  {productImages.length < 5 && (
                    <label className="w-20 h-20 border border-dashed border-[#d4e8d4] rounded-xl flex flex-col items-center justify-center text-[10px] text-[#6B7280] hover:border-[#E65100] hover:text-[#1a3a1a] cursor-pointer transition-colors">
              ...
              <div><label className={labelCls}>Nome</label><input value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} className={inputCls} placeholder="Ex: Aula de Yoga" /></div>
              ...
              <button onClick={() => createMut.mutate()} disabled={createMut.isPending || !form.name} className="bg-[#E65100] text-white px-6 py-2.5 rounded-full text-sm font-medium hover:bg-[#BF360C] transition-colors disabled:opacity-50">
      ...
      <div className="space-y-6">
        {DESPORTO_CATEGORIES.filter((group) => getProductsForGroup(group.category).length > 0).map((group) => {
