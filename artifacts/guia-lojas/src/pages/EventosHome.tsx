  ...
  return (
    <main className="eliora-page">
      <nav className="eliora-nav">
        ...
        <div className="eliora-navlinks"><a href="#servicos">Serviços</a><a href="#processo">Como ajudamos</a><button className="eliora-nav-cta" onClick={() => { setFormOpen(true); document.getElementById("contacto")?.scrollIntoView({ behavior: "smooth" }); }}>Pedir orçamento</button></div>
