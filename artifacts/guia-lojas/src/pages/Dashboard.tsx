        ...
        <div className="max-w-md mx-auto px-4 py-24 text-center space-y-6">
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="flex flex-col gap-2">
              <a
                href={`https://wa.me/244922001778?text=${encodeURIComponent("Olá, meu pedido de loja na YESOLA foi recusado e gostaria de reavaliar.")}`}
                target="_blank"
      ...
      <PageTransition>
        <div className="max-w-md mx-auto px-4 py-24 text-center space-y-6">
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="flex flex-col gap-2">
              <a
                href={`https://wa.me/244922001778?text=${encodeURIComponent("Olá, a minha conta na YESOLA foi suspensa e gostaria de esclarecimentos.")}`}
                target="_blank"
                rel="noopener noreferrer"
                className="w-full bg-[#25D366] hover:bg-[#22c35f] text-white py-2.5 rounded-full text-xs font-semibold transition-colors flex items-center justify-center gap-1.5 border border-black/10 shadow-sm"
              >
...
function LojaSection({ myStore, isDirty, setDirty, saveFnRef }: { myStore: any, isDirty: boolean, setDirty: (d: boolean) => void, saveFnRef?: React.MutableRefObject<any> }) {
  ...
  return (
    <div className="space-y-6 max-w-md">
      ...
      {/* Secção de Localização no Mapa - No topo */}
