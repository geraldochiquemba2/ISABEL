...
const groups: ServiceGroup[] = [
  ...
  },
  {
    ...
    intro: "Tempo bem passado também pode tornar-se uma nova habilidade.",
    items: ["Aulas de Culinária, Confeitaria e Gastronomia", "Canto, Piano, Violão, Guitarra e Outros Instrumentos", "Costura, Modelagem, Corte e Artesanato", "Fotografia Profissional e Produção de Vídeo com Telemóvel"],
    category: "artes",
  },
  {
    number: "06",
