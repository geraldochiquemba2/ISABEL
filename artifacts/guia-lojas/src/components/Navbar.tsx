...
export function Navbar() {
  ...
  return (
    <nav className={`sticky top-0 z-50 transition-all duration-300 ${scrolled ? "shadow-lg" : ""}`}>
      <div 
        className="backdrop-blur-md bg-white/95 border-b border-amber-200/50"
            ...
            <div className="hidden md:flex items-center gap-2">
              ...
              {user ? (
                ...
                <>
                  ...
                  <Link href="/dashboard">
                    <span className="text-sm bg-white text-amber-700 px-5 py-2 rounded-full font-semibold hover:bg-white/90 hover:shadow-lg transition-all">
                      Cadastrar loja
                    </span>
                  </Link>
                </>
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="md:hidden border-b border-amber-200/50"
            ...
            <div className="px-4 py-3 flex flex-col gap-1">
              ...
              {user ? (
                ...
                <>
                  ...
                  <Link href="/dashboard" onClick={() => setMobileOpen(false)}>
                    <span className="block px-4 py-3 rounded-xl text-sm text-amber-700 font-semibold bg-white text-center">
