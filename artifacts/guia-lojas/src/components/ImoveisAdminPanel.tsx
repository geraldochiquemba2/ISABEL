...
const IMOVEIS_CATEGORIES = [
  { number: "01", title: "Hotéis & Resorts", category: "hoteis" },
  { number: "02", title: "Alojamento & Estadias", category: "alojamento" },
  { number: "03", title: "Imobiliária & Compras", category: "imobiliaria" },
];

export function ImoveisAdminPanel() {
      ...
      <div className="space-y-6 max-w-5xl">
        ...
        <div className="flex border-b border-[#d1d4d8] gap-1">
          {([
            ...
            { id: "categorias" as MainTab, label: "Categorias de Imóveis", icon: <Tag size={13} /> },
          ]).map((t) => (
            <button
              key={t.id}
...
function ContasSection() {
  ...
  async function loadUsers() {
    setLoading(true);
    try { setUsers(await fetchAdminUsersFiltered("imoveis")); }
...
function CategoriasSection() {
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-[#87909a]">{groups.length} categorias de imóveis</p>
