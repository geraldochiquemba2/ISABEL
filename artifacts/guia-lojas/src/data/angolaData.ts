...
export const ANGOLA_PROVINCES: Province[] = [
  {
    ...
    localities: {
      ...
      "Barra do Dande": ["Barra do Dande / Sede", "Barra do Dande / Centro", "Foz do Dande", "Catumbo", "Calenguela", "Cambondo", "Cerâmica", "Terra Nova"],
  ...
  },
  {
    ...
    localities: {
      "Cubal": ["Cubal / Sede", "Capupa", "Tumbulo", "Iambala", "Capupa / Sede", "Capupa / Centro", "Iambala / Sede", "Iambala / Centro", "Lomaum", "Imbala"],
      "Benguela": ["Asfalto / Centro", "Camunda", "Calundo", "Cambanda", "Candumbo", "Canequetela", "Casas Novas", "Dokota", "Bimbas", "Kalongoloti", "Kalossombékua", "Kamaninga 1", "Kamaninga 2", "Lixeira", "Lupeio", "Nhime", "Setenta", "Setenta e Um", "28 de Maio", "Utomba", "Baía de Santo António", "Bela Vista", "Caota", "Calonomi", "Calohombo", "Calombutão", "Casseque Goa", "Casseque Macau", "Casseque Marítimo", "Esperança", "Morros", "Navegantes", "Talamaniamba", "Uchi", "São João", "Benfica", "Capiras", "Caponte", "Cassoco", "Fronteira", "Asseque", "Seta Antiga", "Calilongue", "Calomanga", "Chingoma", "Pecuária", "Massangarala", "Cotel", "Quioche", "Graça", "Calomburaco", "Cambangela", "Capilongo", "Tchipiandalo / Capiandalo", "Cavaco", "Cawango", "Damba Maria", "Gama", "Mina", "Taca", "Cambambe", "Santa Teresa", "4 de Abril", "11 de Novembro", "17 de Setembro", "Zona A", "Zona B", "Zona C", "Zona D", "Zona E", "Zona F", "Coruteva", "Gunque", "Binga"],
      "Lobito": ["Restinga", "Comercial / Zona Comercial", "Compão", "Cabaia", "Canata", "Caponte", "Bairro da Luz", "4 de Fevereiro", "Cassai", "Porto", "São Miguel", "N'golo de Areia", "São João", "Boa Vida", "Caimama I", "Caimama II", "Kalumba", "Kalumba I", "Kalumba II", "Akongo", "Santa Cruz", "Morro da Rádio", "Vista Alegre", "Bela Vista Baixa", "Naca Preta", "Boa Esperança", "Alto Esperança", "Bela Vista Alta", "Popular", "1.º Chimbula", "2.º Chimbula", "3.º Chimbula", "Alto Liro", "Zâmbia", "Alto Bocoio", "27 de Março", "17 de Setembro", "Golfe", "Liro", "Bandeira", "Estrela", "Canjendende", "Cavipa", "Pomba", "Lobito Velho", "Centralidade Lobito 3000", "Canjala", "Egito Praia", "Hanha", "Egito Praia Sede", "Egito Praia Centro"],
      "Catumbela": ["Catumbela / Sede", "Catumbela / Centro", "Catumbela-Vila", "Gama", "Biópio", "Praia Bebé", "Biópio / Sede", "Biópio / Centro", "Gama Sede", "Gama Centro", "Praia Bebé Sede", "Praia Bebé Centro"],
      "Baía Farta": ["Baía Farta / Sede", "Baía Farta / Centro", "Baía Farta-Vila", "Dombe Grande", "Calahanga", "Equimina", "Kalohanga", "Calohanga", "Dombe Grande / Sede", "Dombe Grande / Centro", "Equimina Sede", "Equimina Centro", "Calohanga Sede", "Calohanga Centro"],
      "Balombo": ["Balombo / Sede", "Balombo / Centro", "Balombo-Vila", "Chindumbo", "Chingongo", "Maca Mombolo", "Chingonjo", "Maca Mombolo Sede", "Maca Mombolo Centro", "Chingongo Sede", "Chingongo Centro"],
      "Bocoio": ["Bocoio / Sede", "Bocoio / Centro", "Bocoio-Vila", "Chila", "Monte Belo", "Passe", "Cavimbe", "Cubal do Lumbo", "Chila / Sede", "Chila / Centro", "Monte Belo Sede", "Monte Belo Centro", "Cubal do Lumbo Sede", "Cubal do Lumbo Centro", "Passe Sede", "Cavimbe Sede"],
      "Caimbambo": ["Caimbambo / Sede", "Caimbambo / Centro", "Catengue", "Caiave", "Canhamela", "Viangombe", "Cayave", "Wiyangombe", "Catengue / Sede", "Catengue / Centro", "Canhamela / Sede", "Canhamela / Centro", "Caiave Sede", "Caiave Centro", "Viangombe Sede", "Viangombe Centro"],
      "Chongorói": ["Chongorói / Sede", "Chongorói / Centro", "Bolonguera", "Camuine", "Kamuine", "Camuine / Sede", "Bolonguera / Sede", "Bolonguera / Centro", "Camuine Centro", "Kamuine Sede", "Kamuine Centro"],
      "Ganda": ["Ganda / Sede", "Ganda / Centro", "Ganda-Vila", "Babaera", "Chicuma", "Ebanga", "Casseque", "Chikuma", "Chicuma / Sede", "Chicuma / Centro", "Babaera / Sede", "Babaera / Centro", "Ebanga Sede", "Ebanga Centro", "Casseque Sede", "Casseque Centro"]
    }
  },
  {
    id: "bie",
    ...
    localities: {
      "Chicala": ["Chicala / Sede", "Chicala / Centro", "Chicala-Vila", "Chicala Comuna-Sede", "Chicala Vila-Sede"],
      "Cuito": ["Centro / Cidade do Cuito", "Catemo", "Catraio", "Sousa", "Chitumba", "Mayaya", "Embala", "Castanheira", "Piloto", "Bairro Azul I", "Bairro Azul II", "Chissindo", "Bairro Militar", "Caluapanda / Kaluapanda", "Cambulucuto / Kambulucuto", "Cantíflas", "Bairro Popular", "Bairro Fátima", "Bairro Câmara", "Bairro Caluco", "Bairro São António", "Cangoti", "Catala", "Centralidade Horizonte", "Cunje", "Camalaia", "Setecol", "Boa Vista", "Trumba", "Trumba Sede", "Cunje Sede", "Cunje Centro"],
      "Andulo": ["Andulo / Sede", "Andulo / Centro", "Andulo-Vila", "Calucinga", "Cassumbe", "Chivaúlo", "Calucinga / Sede", "Calucinga / Centro"],
      "Camacupa": ["Camacupa / Sede", "Camacupa / Centro", "Cuanza", "Muinha", "Santo António da Muinha", "Ringoma", "Umpulo", "Ringoma / Sede", "Ringoma / Centro", "Cuanza Sede", "Cuanza Centro", "Muinha Sede", "Muinha Centro", "Umpulo Sede", "Umpulo Centro", "Santo António da Muinha Sede"],
      "Catabola": ["Catabola / Sede", "Catabola / Centro", "Caiuera", "Chipeta", "Chiuca", "Sande", "Chissamba", "Chipeta / Sede", "Chipeta / Centro", "Caiuera Sede", "Caiuera Centro", "Sande Sede", "Sande Centro", "Chiuca Sede", "Chiuca Centro"],
      "Chinguar": ["Chinguar / Sede", "Chinguar / Centro", "Cutato", "Cangote"],
      "Chitembo": ["Chitembo / Sede", "Chitembo / Centro", "Cachingues", "Mutumbo", "Mumbué", "Malengue", "Soma Cuanza", "Mumbué / Sede", "Mumbué Centro"],
      ...
      "Nharea": ["Nharea / Sede", "Nharea / Centro", "Gamba", "Lúbia", "Caiei", "Dando", "Caieie", "Lúbia / Sede", "Lúbia / Centro", "Gamba Sede", "Gamba Centro", "Caieie Sede", "Caieie Centro", "Dando Sede", "Dando Centro"]
    }
  },
  {
    id: "cabinda",
    ...
    localities: {
      "Ngoio": ["Ngoio / Sede", "Ngoio / Centro", "Cabinda Norte", "Angoio", "Ngoio-Vila"],
      "Liambo": ["Liambo / Sede", "Liambo / Centro"],
      "Tando Zinze": ["Tando Zinze / Sede", "Tando Zinze / Centro", "Malembo", "Malembo Sede", "Malembo Centro", "Tando-Zinze Vila"],
      "Cabinda": ["Centro / Baixa da Cidade", "1.º de Maio", "4 de Fevereiro", "Deolinda Rodrigues", "Marien Ngouabi", "A Luta Continua", "A Resistência", "Vitória é Certa", "Amílcar Cabral", "Comandante Gika", "Lombo-Lombo", "Simulambuco", "Vala", "Mbuco", "Cabassango", "Lucola", "Chinga", "Chibodo", "Zongolo", "Subantando", "Chiazi", "Urbanização 4 de Abril / Chibodo", "Centralidade do Chibodo", "Centralidade do Chibodo II", "Vila Olímpica do Cabassango", "Santa Catarina", "Tchinganga", "Povo Grande", "Fortaleza", "Tafe", "Fútila", "Caio", "Malembo", "Malongo", "Tando-Zinze", "Ponta do Farol", "Luvassa", "Mongo Balança", "Ambaca", "Lúcio Tchiweka", "Morro do Chizo", "Zangoio", "Mangue Seco", "Emcica", "Chioua", "Chinfuca"],
      "Cacongo": ["Cacongo / Sede", "Cacongo / Centro", "Cacongo-Vila", "Landana", "Dinge", "Massabi", "Massabi / Sede", "Massabi / Centro", "Lagoa Massabi", "Dinge Sede", "Dinge Centro", "Landana Sede"],
      "Buco-Zau": ["Buco-Zau / Sede", "Buco-Zau / Centro", "Buco-Zau-Vila", "Inhuca", "Necuto", "Necuto / Sede", "Necuto / Centro", "Inhuca Sede", "Inhuca Centro"],
      "Belize": ["Belize / Sede", "Belize / Centro", "Luali", "Miconje", "Miconje / Sede", "Miconje / Centro", "Miconje-Vila", "Luali Sede", "Luali Centro", "Belize-Vila"]
    }
  },
  {
    id: "cuanza-norte",
  ...
  },
  {
    ...
    localities: {
      ...
      "Namacunde": ["Namacunde / Sede", "Namacunde / Centro", "Namacunde-Vila", "Chiede", "Melunga-Chiede", "Chiede / Sede", "Melunga", "Santa Clara do Cunene", "Oihole", "Fronteira de Santa Clara"],
      "Ombadja": ["Xangongo", "Xangongo / Sede", "Xangongo / Centro", "Ombala yo Mungu", "Naulila", "Humbe", "Mucope", "Ombala-Yo-Mungo", "Humbe / Sede", "Calueque", "Ombala-Ya-Nalueque", "Roçadas", "Santa Clara", "Oshietekela", "Naulila Sede", "Naulila Centro", "Humbe Centro"]
    }
  },
  {
    id: "huambo",
    ...
    localities: {
      "Huambo": ["São João", "São João Vilinga", "Cambiote", "Chitutula", "Sassonde 1", "Sassonde 2", "Sassonde 3", "Santo António", "Cavongue", "Cavongue Centro", "Cavongue Baixo", "Cacilhas", "Santa Iria", "Bairro Académico", "Vila Verde", "Calute", "Joaquim Kapango / Kapango", "Munda Paiva", "8 de Fevereiro", "Canhe", "Macolocolo", "Calomanda", "São Luís", "Juventude", "Centralidade do Lossambo", "Lossambo", "Culimahala", "Benfica", "Casseque", "Casseque I", "Casseque II", "Cassenda", "Lufefena", "Lufefena I", "Lufefena II", "Bairro de Fátima", "Bom Pastor", "Camussamba", "Capilongo Baixo", "Capilongo Alto", "Aeroporto", "Bairro do Comércio", "Brigada", "Colemba", "Frederico", "Santa Teresa", "Carilongue", "Lumato", "Camunda Sede", "Cacareua", "Estêvão", "Cidade Alta", "Cidade Alta Sul", "Cidade Baixa", "Casa dos Rapazes", "Bairro Azul", "Mukulonda", "São José", "Canata", "Sandangote", "Bomba Baixa", "Bomba Centro", "Vila Graça", "Tchiva / Chiva", "Quilombo", "Kandjaya", "Calilongue da Cuca", "São Pedro", "São Pedro Urbano", "Licima", "Catumanda", "Aviação", "Mungonane", "Amidos", "Calombringo", "Calilongue", "São Bento", "Kalundo", "Kakelewa", "Chivela", "Munda", "Santa Nganguela", "Belém do Huambo", "Lissimo", "Raimundo", "Ussolo", "Zona Alta", "Rua Bié / Bairro Militar", "Bairro Militar", "Calima", "Chipipa", "Calima Sede", "Calima Centro"],
      "Caála": ["Caála Sede", "Caála Velha", "Cemitério (Kalundo)", "Catelenga Velha", "Catelenga Nova", "Cayengula", "Sanhami", "Lenha", "Caterça", "Bloco 7", "Cangola", "Katerça", "Kalilongue", "Kangoti", "Codume", "São Paulo", "CRC", "Mwangunja", "Tchandenda", "Tchipa-Tchiwa", "Compão", "Santa Teresa", "Calai-Brita", "Mangumbala", "Camiliquinhentos", "Cantão Paula", "Mussili", "Ndongwa", "Ngundgi", "Vicassa", "Kambongue", "Kaluwe", "Bem Morar / Quadra Zero", "Centralidade Fernando Faustino Muteca", "Lufefena", "Calenga", "Catata", "Cuima", "Catata Sede", "Catata Centro", "Calenga Sede", "Calenga Centro", "Cuima Sede", "Cuima Centro"],
      "Bailundo": ["Bailundo / Sede", "Bailundo / Centro", "Bailundo-Vila", "Lunge", "Luvemba", "Bimbe", "Hengue", "Hengue-Caculo", "Bimbe / Sede", "Bimbe / Centro", "Buta", "Camela", "Chipela", "Lupili", "Santa Ana", "Santa Inês", "São Miguel", "Wassuya", "Chissanga", "Cateteles"],
      "Catchiungo": ["Cachiungo / Sede", "Catchiungo / Centro", "Chinhama", "Chiumbo", "Cachiungo", "Tchinhama", "Tchiumbo", "Chinhama Sede", "Chinhama Centro", "Chiumbo Sede", "Chiumbo Centro"],
      "Ecunha": ["Ecunha / Sede", "Ecunha / Centro", "Quipeio", "Comuna Sede", "Chipeio", "Quipeio / Sede", "Quipeio Centro", "Chipeio Sede", "Chipeio Centro"],
      "Londuimbale": ["Londuimbale / Sede", "Londuimbale / Centro", "Alto Hama", "Ussoque", "Galanga", "Cumbira", "Londuimbali", "Cumbila", "Kumbila", "Ngalanga", "Galanga / Sede", "Galanga / Centro", "Alto Hama / Sede", "Alto Hama / Centro", "Ussoque Sede", "Ussoque Centro"],
      "Longonjo": ["Longonjo / Sede", "Longonjo / Centro", "Lépi", "Catabola", "Chilata", "Lépi / Sede", "Iava", "Ngombe Ya Lamba", "Lépi Centro", "Catabola Sede", "Catabola Centro"],
      "Mungo": ["Mungo / Sede", "Mungo / Centro", "Cambuengo", "Comuna Sede", "Cambuengo / Sede"],
      "Tchicala-Tcholoanga": ["Chicala-Choloanga / Sede", "Tchicala-Tcholoanga / Centro", "Mbave", "Sambo", "Chicala", "Hungulo", "Samboto", "Sambo / Sede", "Sambo / Centro", "Mbave Sede", "Mbave Centro", "Chicala Sede", "Chicala Centro"],
      "Tchindjenje": ["Chinjenje / Sede", "Tchindjenje / Centro", "Chiaca", "Comuna Sede", "Chinjenje", "Tchiaca", "Chiaca / Sede", "Chinjenje Centro", "Chiaca Centro", "Tchiaca Sede", "Tchiaca Centro"],
      "Ucuma": ["Ucuma / Sede", "Ucuma / Centro", "Cacoma", "Mundundo", "Mundundo (Eleva)", "Cacoma / Sede", "Cacoma Centro", "Mundundo Sede", "Mundundo Centro"]
    }
  },
  {
    id: "huila",
    ...
    localities: {
      ...
      "Gambos": ["Gambos / Sede", "Chiange", "Chimbemba", "Cahila", "Viriambundu", "Nondjelo", "Mumpombo", "Muntyaulua", "Tunda", "Chimbolela", "Kampanda"],
      ...
      "Chibia": ["Chibia / Sede", "Chibia / Centro", "Capunda-Cavilongo", "Quihita", "Jau", "Tchicuatiti", "Lufinda", "Olivença-a-Nova", "Capunda Cavilongo Sede", "Capunda Cavilongo Centro"],
      "Chicomba": ["Chicomba / Sede", "Chicomba / Centro", "Cutenda", "Comuna Sede", "Kutenda", "Libongue", "Quê", "Calueyo", "Luvindja", "Alto Lussonde", "Candunda Baixa", "Cutenda Sede", "Sede Libongue", "Quê Sede", "Banga Kongua"],
      "Chipindo": ["Chipindo / Sede", "Chipindo / Centro", "Bambi", "Comuna Sede", "Bunjei", "Bambi / Sede", "Calonalê", "Ndala", "Ndovala", "Ngolo", "Sapi", "Tandala", "Tchicala", "Ussilano"],
      "Cuvango": ["Cuvango / Sede", "Cuvango / Centro", "Galangue", "Vicungo", "Vicungo / Sede", "Galangue / Sede", "Galangue / Centro", "Cambomgue", "Catala", "Cuando Kativa", "Kalulu", "Kapalala", "Mumba", "Tchiongo"],
      "Humpata": ["Humpata / Sede", "Humpata / Centro", "Bata-Bata", "Caholo", "Neves", "Palanca", "Tchivinguiro", "Leba", "Alto-Bimbi", "Estação Zootécnica", "Heva", "Bimbi", "Cipembe", "Hongo", "Palanca Sede", "Palanca Centro"],
      ...
      "Quipungo": ["Quipungo / Sede", "Quipungo / Centro", "Comuna Sede", "Cainda", "Ombo", "Hombo", "Sêndi", "Chicungo", "Thicungo", "Tchiconco", "Barragem do Sendi", "Barragem do Chicungo", "Chicungo Sede", "Chicungo Centro"]
    }
  },
  {
    id: "luanda",
    ...
    localities: {
      ...
      "Cacuaco": ["Cacuaco", "Kikolo", "Paraíso", "Boa Esperança", "Augusto Ngangula", "Cerâmica", "Vidrul", "Belo Monte", "Pescadores", "Kianda", "Pedreira", "Kifangondo", "Panguila", "Barra do Bengo", "Forno de Cal", "Boa Esperanca Central", "Funda", "Sequele", "Salinas", "Nazaré", "Embondeiro", "Musseque", "Sarico", "Bairro Trinta", "Caop Velha", "Caop Nova"],
      ...
      "Mussulo": ["Mussulo", "Ilha do Mussulo", "Ponta da Barra", "Macoco", "Cambaxi", "Ilha da Cazanga", "Ilheu dos Passaros", "Ilha do Desterro", "Ilha da Quissanga", "Ponta da Mussulo", "Priori", "Mussulo Centro", "Contra Costa do Mussulo Centro", "Contra Costa da Ponta da Barra", "Buraco", "Tapo", "Farol"],
      ...
      "Camama": ["Camama", "Camama Sede", "Nova Esperança", "Rei Mandume", "4 de Abril", "Njinga Bande", "Chimbicato", "Simione", "Sonho da Casa Própria", "Jardim do Éden", "Progresso", "Simione I", "Simione II", "Mbondo Chape", "Casas Azuis", "Camama II", "Cidade Universitária", "Estádio 11 de Novembro", "Residencial Camama", "Mbondo Chapé Centro", "Mbondo Chapé I", "Mbondo Chapé II", "15 de Fevereiro", "Antigos Guerrilheiros", "BPC I", "BPC II", "Wenji Maka", "Bairro da Paz"],
      "Mulenvos": ["Mulenvos", "Mulenvos de Cima", "CAOP-B", "Capalanga", "Estalagem", "Mulenvos de Baixo", "Balumuka", "Bairro dos Mulenvos", "Km-9B", "12B", "14B", "Cambiri", "Caop-A", "Caop-C", "Boa-Fé", "Baixa de Cassanje", "Ndolela"],
      "Kilamba": ["Centralidade do Kilamba", "Kilamba", "KK5000", "Projecto Mil Cores", "Vila Flor", "Bita", "Cinco Fios", "Povoado Kimbele", "Sapu Velho", "Quenguela", "Progresso", "Via da Mutamba", "Rua da Mana Bela", "Rua da Magericel"],
      "Hoji ya Henda": ["Hoji ya Henda", "São João", "Fabimor", "Bairro dos Ossos", "Sao Pedro", "Santo Antonio", "Adriano Moreira", "11 de Novembro", "Ngola Kiluanje", "Cazenga Popular", "Distrito Industrial", "Petrangol", "Bacia de Retenção"],
  ...
  },
  {
    ...
    localities: {
      ...
      "Cuango": ["Cuango", "Luzamba", "Luremo", "Cuango / Sede", "Luzamba / Centro", "Cuango-Luzamba", "Vila de Luzamba"],
      "Cuilo": ["Caluango", "Cuilo", "Cuilo / Centro", "Cuilo / Sede", "Caluango / Sede", "Camuenda", "Chicoca", "Muacamana"],
      ...
      "Dundo": ["Dundo", "Luachimo", "Cacanda", "Camatundo", "Cassanguidi", "Samacaca", "Camaquenzo", "Centralidade do Dundo", "Bairro Norte", "Estufa", "Bairro Sul", "Sachindongo", "4 de Abril", "Distrito Urbano do Chitato", "Distrito Urbano do Dundo", "Distrito Urbano do Mussungue"],
      ...
      "Chitato (Dundo)": ["Dundo / Centro", "Dundo-Chitato", "Luachimo", "Samacaca", "Camaquenzo", "Centralidade do Dundo", "Bairro Norte", "Bairro Sul", "Estufa", "Sachindongo", "4 de Abril", "Caxinde", "Distrito Urbano do Chitato", "Distrito Urbano do Dundo", "Distrito Urbano do Mussungue"]
    }
  },
  {
    id: "lunda-sul",
    ...
    localities: {
      "Saurimo": ["Agostinho Neto", "11 de Novembro", "Sassamba", "Bairro Verde", "Luavur", "Chicumina", "Candembe II", "Sacombe", "Nzaji", "Acampamento", "Mona Quimbundo", "Lufune", "Catoca", "Saulimbo", "Nguali", "Muatxissengue", "Sambau", "Txicucu", "Luele-Samahiji", "Txicomina", "Candala", "Salupa", "Sombo", "Santo Antonio", "Sambuquila", "Terra-Nova", "Chizainga I", "Chizainga II", "Juventude", "Candembe", "Soma", "Fera", "Camitundo", "Passa-bem", "Manalto", "Aldeia Missão", "Fina", "Nhama", "Kamanhundu", "Verde A", "Verde B", "Candembe I"],
      "Cacolo": ["Cacolo / Sede", "Cacolo / Centro", "Alto Chicapa", "Xassengue", "Cucumbi", "Alto-Chicapa", "Xassengue / Sede", "Xassengue / Centro", "Alto Chicapa / Sede", "Alto Chicapa / Centro", "Txizeca", "Alto Cavemba", "Sola", "Txissumbi", "Muatxinongue", "Txiuihua", "Muacatende", "Minungo"],
  ...
  },
  {
    ...
    localities: {
      "Kiwaba Nzoji": ["Kiwaba Nzoji / Sede", "Kiwaba Nzoji / Centro", "Mufuma", "Mufuma Sede", "Mufuma Centro"],
      "Malanje": ["Centro / Cidade de Malanje", "Maxinde", "Catepa / Katepa", "Canâmbua", "Cangambo / Kangambu", "Ritondo", "Quizanga / Kizanga", "Vila Matilde", "Carreira de Tiro I", "Carreira de Tiro II", "Centralidade de Malanje", "Cahala", "Camoma", "Cambundi do Kuiji", "Campo de Aviação", "Massaca", "Cambondo", "Kulamuxito", "Gaiato", "Quizanga da Barraca", "Cafucufuco", "Canzamba", "Cambaxe", "Ngola Luiji Sede", "Ngola Luiji Centro", "Cambaxe Sede", "Cambaxe Centro"],
      "Cacuso": ["Cacuso / Sede", "Cacuso / Centro", "Lombe", "Quizenga", "Pungo-Andongo", "Soqueco", "Pungo a Ndongo Sede", "Pungo a Ndongo Centro"],
      ...
      "Quela": ["Quela / Sede", "Quela / Centro", "Xandele", "Moma", "Bângalas", "Missão dos Bangalas", "Xandel", "Bângalas Sede", "Bângalas Centro"],
  ...
  },
  {
    ...
    localities: {
      ...
      "Moxico (Luena)": ["Centro / Cidade do Luena", "Santa Rosa", "Social da Juventude", "Sinai Velho", "Sinai Novo", "Kapango", "Sangondo", "Mandembwe", "Nzaji", "Tchifuchi", "Alto Luena", "4 de Fevereiro", "11 de Novembro", "4 de Abril", "Passa Fome", "Aço", "Kawango", "Cangamba", "Tchicala", "Km 5", "Km 7", "Km 9", "Km 11", "Sacassange", "Lucusse", "Cachipoque", "Muangai", "Popular", "Alto Campo", "Zona Verde", "Cassongo"],
  ...
  },
  {
    ...
    localities: {
      ...
      "Virei": ["Virei / Sede", "Virei / Centro", "Cainde", "Chitundo-Hulu", "Capolopopo", "Morro do Tchitundulo"],
      ...
      "Tômbwa": ["Tômbwa / Sede", "Tômbwa / Centro", "Porto Alexandre", "Iona", "São Martinho dos Tigres", "Yona", "Savo-Mar", "Torre do Tambo", "Iona / Sede", "Iona / Centro", "Baía dos Tigres", "Ilha dos Tigres", "Lagoa do Arco", "Monte Negro", "Tchinungua", "Tchavaya", "Otchifengo", "Cambeno", "Garota Nova", "Lutuima", "Humbi", "Mupaka"]
    }
  },
  {
    id: "uige",
    ...
    localities: {
      "Nsosso": ["Nsosso / Sede", "Nsosso / Centro", "Nsosso-Vila", "Mbanza Nnosso", "Lombe"],
      "Cangola": ["Cangola / Sede", "Cangola / Centro", "Caiongo", "Bengo", "Bengo Sede", "Bengo Centro", "Caiongo Sede", "Caiongo Centro", "Cangola-Vila", "Alto Cauale"],
      "Songo": ["Songo / Sede", "Songo / Centro", "Quivuenga", "Quivuenga Sede", "Quivuenga Centro", "Songo-Vila", "Songo Comuna-Sede"],
      ...
      "Negage": ["Negage / Sede", "Negage / Centro", "Dimuca", "Quisseque", "Capopa", "Cangundo", "Gozolo", "Kimbanzi", "Bula", "Piri", "Entre-os-Rios", "Dimuca Sede", "Dimuca Centro", "Quisseque Sede", "Quisseque Centro"],
      "Mucaba": ["Mucaba / Sede", "Mucaba / Centro", "Uando", "Comuna Sede", "Uando Mucaba", "Uando Mucaba / Centro"],
      "Maquela do Zombo": ["Maquela do Zombo / Sede", "Maquela do Zombo / Centro", "Quibocolo", "Béu", "Cuilo Futa", "Sacandica", "Quibocolo Sede", "Quibocolo Centro", "Maquela do Zombo-Vila"],
  ...
  },
  {
    ...
    localities: {
      "Quêlo": ["Quêlo / Sede", "Quêlo / Centro", "Pedra de Feitiço", "Binga", "Bungo", "Luano", "Nkegue", "Nenga", "Nsanga", "Vombo", "Mponzo", "Chinde", "Lumueno"],
      "Mbanza Kongo": ["Centro / Centro Histórico", "Sagrada Esperança", "4 de Fevereiro", "11 de Novembro", "Álvaro Buta", "Martins Kiditu", "Deolinda Rodrigues", "Caluca", "Quiende", "Madimba", "Calambata", "Luvo", "Luvu", "Nkoko"],
  ...
  },
  {
    id: "cuando",
    name: "Cuando",
    municipalities: ["Menongue", "Cuchi", "Cuito Cuanavale", "Nancova", "Xipundo", "Dima", "Luiana", "Mucusso", "Luengue", "Dirico", "Rivungo"],
    localities: {
      "Rivungo": ["Rivungo Sede", "Rivungo Centro"],
      "Dirico": ["Dirico Sede", "Dirico Centro"],
      ...
      "Cuito Cuanavale": ["Cuito Cuanavale / Centro", "Samaria", "Tchissamba", "Tchambinga", "Sacalumbo", "Mavinga", "Longa", "Lupire", "Baixo Longa", "Missombo", "Tumpo", "Chambinga", "Samungure", "Sacatengo", "Cachimbo", "Chinguanja", "Licua", "Lupembe", "Cunjamba", "Cuito Cuanavale Velho", "Dima", "Luengue", "Xipundo", "Luiana", "Mucusso", "Mavinga Sede", "Mavinga Centro"],
  ...
  },
  {
    ...
    localities: {
      "Caiundo": ["Caiundo / Sede", "Cueio-Betre", "Missombo", "Jamba Cueio", "Caila"],
      ...
      "Cuangar": ["Cuangar / Sede", "Cuangar / Centro", "Savate", "Bondo", "Bondo-Caila", "Savate / Sede", "Savate / Centro", "Katuitui"],
  ...
  },
  {
    ...
    localities: {
      ...
      "Alto Zambeze": ["Cazombo", "Cazombo / Sede", "Cazombo / Centro", "Nana Candundo", "Lumbala Caquengue", "Macondo", "Caianda", "Calunda", "Cavungo", "Lóvua", "Lumbala-Caquengue", "Lóvua Leste", "Nana Candundo Sede", "Nana Candundo Centro", "Caianda Sede", "Caianda Centro", "Macondo Sede", "Macondo Centro"],
